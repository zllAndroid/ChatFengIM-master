package com.mding.chatfeng.base_common.components.model.linkman.good_friends;
...
public class DataContactsFriendChild {
    ...
    public DataContactsFriendChild(String img_child_head_f, String tv_child_name_f, String tv_child_state_f, String tv_child_motto_f) {
        ...
        this.tv_child_motto_f = tv_child_motto_f;
    }
    ...
    public String getTv_child_name_f() {
        return tv_child_name_f;
    }

    public void setTv_child_name_f(String tv_child_name_f) {
        this.tv_child_name_f = tv_child_name_f;
    }

    public String getTv_child_state_f() {
        return tv_child_state_f;
    }

    public void setTv_child_state_f(String tv_child_state_f) {
        this.tv_child_state_f = tv_child_state_f;
    }

    public String getTv_child_motto_f() {
        return tv_child_motto_f;
    }

    public void setTv_child_motto_f(String tv_child_motto_f) {
        this.tv_child_motto_f = tv_child_motto_f;
    }
