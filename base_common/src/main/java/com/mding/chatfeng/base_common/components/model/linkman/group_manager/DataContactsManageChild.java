package com.mding.chatfeng.base_common.components.model.linkman.group_manager;
...
public class DataContactsManageChild {
    ...
    public String getTv_child_name_m() {
        return tv_child_name_m;
    }

    public void setTv_child_name_m(String tv_child_name_m) {
        this.tv_child_name_m = tv_child_name_m;
    }

    public String getTv_child_state_m() {
        return tv_child_state_m;
    }

    public void setTv_child_state_m(String tv_child_state_m) {
        this.tv_child_state_m = tv_child_state_m;
    }

    public String getTv_child_motto_m() {
        return tv_child_motto_m;
    }

    public void setTv_child_motto_m(String tv_child_motto_m) {
    ...
    public DataContactsManageChild() {
    }
