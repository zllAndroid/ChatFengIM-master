...
/**
 * socket一次性使用的业务，比如文件上传完即关闭的业务
 */
public class DoSendSocket {
...
//                mManager.getPulseManager().trigger();
    ...
    public DoSendSocket(CC cc) {
//        mInfo = new ConnectionInfo(AppConfig.skProtocolIp, AppConfig.skProtocolPort);
