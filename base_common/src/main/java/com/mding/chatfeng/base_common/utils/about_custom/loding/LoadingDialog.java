package com.mding.chatfeng.base_common.components.about_custom.loding;
...
import com.mding.chatfeng.base_common.utils.aboutsystem.ScreenUtils;
...
public class LoadingDialog implements FinishDrawListener {
    ...
    private void initView(View view) {
        ...
        mIvGif = (ImageView) view.findViewById(R.id.lv_iv_gif);
        ViewGroup.LayoutParams layoutParams = mIvGif.getLayoutParams();
        layoutParams.width = ScreenUtils.getScreenWidth(mContext)/2;
        layoutParams.height =ScreenUtils.getScreenHeight(mContext)/4;
        mIvGif.setLayoutParams(layoutParams);
//        setWidth((MainActivity.screenWidth)/2);
////        setWidth(WindowManager.LayoutParams.MATCH_PARENT/2);
//        setHeight((MainActivity.screenHeight) / 4);
//        Glide.with(mContext).load(R.raw.beibao).skipMemoryCache(true).into(mIvGif);
        initData();
    }
