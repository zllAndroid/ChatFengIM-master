...
import com.mding.chatfeng.base_common.utils.about_main_utils.MD5Utils;
 ...
 * 修改者：ljj
 */
public class ChatFunctionFragment extends ChatBaseFragment implements View.OnClickListener{
    ...
    private void initUI() {
        addOnClickListeners(R.id.chat_function_photo, R.id.chat_function_camera, R.id.chat_function_video,
                  R.id.chat_function_voice, R.id.chat_function_transfer, R.id.chat_function_card);
    }
...
//                        SPUtils.put(this,AppConfig.CHAT_SEND_TIME,"");
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == R.id.chat_function_photo) {//权限判断
...
//                ToastUtil.isDebugShow(getResources().getString(R.string.stay_tuned));
        ...
        } else if (i == R.id.chat_function_camera) {
            destoryImage();
            getPicturesFile();
//                ToastUtil.isDebugShow(getResources().getString(R.string.stay_tuned));
        ...
        } else if (i == R.id.chat_function_voice) {
            ToastUtil.show(getResources().getString(R.string.stay_tuned));

        } else if (i == R.id.chat_function_transfer) {
            ToastUtil.show(getResources().getString(R.string.stay_tuned));

        } else if (i == R.id.chat_function_card) {
            ToastUtil.show(getResources().getString(R.string.stay_tuned));
