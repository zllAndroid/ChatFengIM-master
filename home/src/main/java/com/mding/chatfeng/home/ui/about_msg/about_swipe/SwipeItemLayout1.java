package com.mding.chatfeng.home.ui.about_msg.about_swipe;
 ...
 */
public class SwipeItemLayout1 extends FrameLayout {
    ...
    public SwipeItemLayout1(Context context, AttributeSet attrs, int defStyleAttr) {
...
//右滑关闭
    ...
    private void initcus(MotionEvent event) {
        float x = event.getX();
        float y = event.getY();
...
//            close();
    ...
    public interface SwipeListener {
        void onSwipeOpen(SwipeItemLayout1 view);

        void onSwipeClose(SwipeItemLayout1 view);
    }
}
