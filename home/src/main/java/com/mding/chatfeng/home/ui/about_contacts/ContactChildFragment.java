package com.mding.chatfeng.home.ui.about_contacts;
...
import com.mding.chatfeng.base_common.components.model.DataLinkGroupList;
...
import com.mding.chatfeng.home.about_broadcastreceiver.LinkChangeEvent;
...
import com.mding.chatfeng.home.ui.about_contacts.adapter.LinkFriendAdapter;
import com.mding.chatfeng.home.ui.about_contacts.adapter.LinkGroupAdapter;
...
//            获取群组列表
    ...
    private void initDataFriend(String responseText,String isWs) {
        ...
        if (isWs.equals(USE_WS)) {
            DataLinkManList dataLinkManList = new GsonParamConverter().json2Object(responseText, DataLinkManList.class);
//                    DataLinkManList dataLinkManList = JSON.parseObject(responseText, DataLinkManList.class);
            record = dataLinkManList.getRecord();
        }else
        {
            record =new GsonParamConverter().json2Object(responseText, DataLinkManList.RecordBean.class);
...
//                    IntentUtils.JumpToHaveOne(FriendDataMixActivity.class,"id",userId);
    ...
    private void initDataGroup(String responseText,String isWs) {
        ...
        if (isWs.equals(USE_WS)) {
            DataLinkGroupList dataLinkGroupList = new GsonParamConverter().json2Object(responseText, DataLinkGroupList.class);
//            DataLinkGroupList dataLinkGroupList = JSON.parseObject(responseText, DataLinkGroupList.class);
            ...
            record1 =  new GsonParamConverter().json2Object(responseText, DataLinkGroupList.RecordBean.class);
