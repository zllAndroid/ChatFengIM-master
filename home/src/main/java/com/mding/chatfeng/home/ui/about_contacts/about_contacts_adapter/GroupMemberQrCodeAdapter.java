package com.mding.chatfeng.home.ui.about_contacts.about_contacts_adapter;//package com.mding.chatfeng.main_code.ui.about_contacts.about_contacts_adapter;
//
...
//import com.mding.model.DataScanGroupRequest;
...
//
//public class GroupMemberQrCodeAdapter extends BaseQuickAdapter<DataScanGroupRequest.RecordBean.GroupDetailInfoBean.GroupUserInfoBean,BaseViewHolder> {
//
//    List<DataScanGroupRequest.RecordBean.GroupDetailInfoBean.GroupUserInfoBean> searchCityList;
//    Context context;
//    boolean isShowName;
//    public GroupMemberQrCodeAdapter(Context context, List<DataScanGroupRequest.RecordBean.GroupDetailInfoBean.GroupUserInfoBean> searchCityList, boolean isShowName)
//    {
...
//    }
//    @Override
//    protected void convert(BaseViewHolder helper, DataScanGroupRequest.RecordBean.GroupDetailInfoBean.GroupUserInfoBean item)
//    {
//
//    }
//
...
//
//
//        DataScanGroupRequest.RecordBean.GroupDetailInfoBean.GroupUserInfoBean item = searchCityList.get(positions);
